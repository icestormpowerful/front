app.controller("Bpart1Controller", ['$scope','$rootScope','$http','$location','$mdDialog','$window','$mdToast',function($scope,$rootScope,$http,$location,$mdDialog,$window,$mdToast) {
  $rootScope.header_path="html/header1.html";
  $scope.inlcudehtmlpath="html/Bpages/Bpart1-1.html";
  $scope.inlcudeb24nhtmlpath="html/Bpages/Bpart1-4-1-0.html";
  ...
  $scope.gettablerowspan= function(itemlength,array){
    ...
    $scope.C2view_subsidy_detail = function (subsidyindex) {
        ...
        $scope.inlcudehtmlpath="html/Bpages/Bpart1-3.html";
  ...
  $scope.addwayradiochange1= function(change){
    if(change==1)
      ...
      $scope.inlcudehtmlpath="html/Bpages/Bpart1-4-0.html";
  ...
  var selectb24screen = function(change){
    if(change==1)
    {
      $scope.inlcudeb241nhtmlpath = "html/Bpages/Bpart1-4-1-1.html";
      $scope.policeid = $scope.C2displaysubsidylist[$scope.C3subsidy_index].id;
      $http({
          method: 'get',
      ...
      $scope.inlcudeb241nhtmlpath = "html/Bpages/Bpart1-4-1-2.html";
      $scope.policeid = $scope.C2displaysubsidylist[$scope.C3subsidy_index].id;
      $http({
          method: 'get',
          url: http_url + "api/bscreen/b2_get_request/" + $scope.policeid,
      ...
      $scope.inlcudeb241nhtmlpath = "html/Bpages/Bpart1-4-1-3.html";
      $scope.policeid = $scope.C2displaysubsidylist[$scope.C3subsidy_index].id;
...
$scope.C5availablesubsidyarray=[];
  ...
  $scope.sidebarbuttonclicked = function(change)
  {
    if(change==1)
    { 
      $scope.inlcudehtmlpath = "html/Bpages/Bpart1-4-2.html";
      $http({
          method: 'get',
    ...
    { 
      $scope.inlcudehtmlpath = "html/Bpages/Bpart1-5.html";
    }
    else if(change==3)
    { 
      $scope.inlcudehtmlpath = "html/Bpages/Bpart1-6.html";
          var i=0,j=0;
          $http({
          method: 'get',
    ...
    { 
      $scope.inlcudehtmlpath = "html/Bpages/Bpart1-8.html";
    }
  }
  ...
  $scope.bigcategorytoggle = function (index, item) {
      ...
      var directtoC2screen = function(){
        $http({
          ...
          $scope.C2displaysubsidylist=response.data.result;
            ...
            $scope.inlcudehtmlpath="html/Bpages/Bpart1-2.html";
            console.log(response.data);
      ...
      $scope.C6view_subsidy_detail = function (parentindex , detailindex) {
        ...
        $scope.inlcudehtmlpath="html/Bpages/Bpart1-7.html";
      };
      ...
      $scope.C8addsubsidy = function () {
        ...
        $http({
          ...
          headers: {'Content-Type': 'application/json'}
            ...
            $scope.inlcudehtmlpath="html/Bpages/Bpart1-9.html";
          });
      };
