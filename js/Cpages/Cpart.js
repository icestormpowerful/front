app.controller("CpartController", ['$scope','$rootScope','$http','$location','$mdDialog','$window','$mdToast',function($scope,$rootScope,$http,$location,$mdDialog,$window,$mdToast) {
	$rootScope.header_path="html/header1.html";
	$scope.inlcudehtmlpath="html/Cpages/C1.html";
  ...
  $scope.downeddisplaycompanystring=[];
	...
	$scope.addwayradiochange= function(change){
		if(change==1)
			...
			$scope.inlcudehtmlpath="html/Cpages/C7.html";
		}
	}
  ...
  $scope.backtoC1screen= function(){
	...
	$scope.bigcategorytoggle = function (index, item) {
      ...
      $scope.searchSubsidy = function () {
        console.log($scope.selectedavailablebalance);
      	if($scope.selectedcategorystring.length>0&&$scope.selectedavailablebalance.value!=false){
      		...
      		sessionStorage.C2refresshsendurl="api/agency/policy_search";
		    directtoC2screen();
	    }
	    else{
	    	alert("plz fill all field correct!");
      ...
      var directtoC2screen = function(){
      	$http({
            ...
            $scope.C2pagination.current_page=1;
	          $scope.inlcudehtmlpath="html/Cpages/C2.html";
	        });
      }
      ...
      $scope.C2view_subsidy_detail = function (subsidyindex) {
        ...
        $scope.inlcudehtmlpath="html/Cpages/C3.html";
      };
      ...
      $scope.direct_set_balance = function() {
        if($scope.selectedsubsidyarray.length>0){
          $scope.inlcudehtmlpath="html/Cpages/C4.html";
        }
        else
      ...
      $scope.direct_C5screen = function() {
          $scope.inlcudehtmlpath="html/Cpages/C5.html";
          var i=0,j=0;
          $http({
          method: 'get',
      ...
      $scope.C6view_subsidy_detail = function (parentindex , detailindex) {
        ...
        $scope.inlcudehtmlpath="html/Cpages/C6.html";
      };
    ...
    $scope.C7balancesetting = {
      ...
      $scope.C7clickaddsubsidy = function () {
        ...
        $scope.inlcudehtmlpath="html/Cpages/C8.html";
      };
